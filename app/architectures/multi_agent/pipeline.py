"""Multi-agent pipeline placeholder.

The multi-agent LLM architecture is not implemented yet, but it honors the
shared ``run`` contract so the CLI and comparison tooling keep working.
"""
